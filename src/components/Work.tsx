...
const projects = [
  {
    ...
    tools: "Python, Machine Learning, Cybersecurity",
    image: "/images/Solidx.png",
  },
  {
    title: "AI Chatbot",
    category: "Natural Language Processing, AI",
    tools: "Python, NLP, TensorFlow, DialogFlow",
  ...
  },
  {
    ...
    category: "IoT, Arduino, Sensors",
    tools: "Arduino, C++, IoT Sensors, Raspberry Pi",
